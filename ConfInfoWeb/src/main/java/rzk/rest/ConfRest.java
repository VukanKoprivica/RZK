...
public class ConfRest {
	...
	public boolean register(ConferencePredavac cp) {
		return confInfo.register(cp);
	}
	
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public List<Conference> getConfs(@QueryParam("ime")String ime, @QueryParam("prezime")String prezime){
		return confInfo.getConfs(ime, prezime);
	}
}
