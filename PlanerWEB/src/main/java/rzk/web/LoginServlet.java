...
public class LoginServlet extends HttpServlet {
	...
	private static PlanerBeanRemote doLookup() {
		...
		try {
			...
			bean = (PlanerBeanRemote) context.lookup("ejb:PlanerEAR/PlanerEJB/PlanerBean!rzk.PlanerBeanRemote?stateful");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (email.equals("")) {
			...
			/// request.getAttribute("bean2");
			List<EventType> listCat= bean.vratiListu();
